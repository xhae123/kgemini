...
public object ModelCatalog {
    ...
    public val entries: List<ModelMetadata> = listOf(
        ModelMetadata(
            ...
            description = "Best price-performance for most tasks with reasoning capabilities.",
            contextWindow = 1_048_576,
            maxOutputTokens = 65_536,
            inputPricePerMToken = 0.30,
            outputPricePerMToken = 2.50,
            bestFor = listOf("general chat", "code generation", "agentic tasks"),
        ),
        ModelMetadata(
            model = GeminiModel.Known.FLASH_2_5_LITE,
            displayName = "Gemini 2.5 Flash Lite",
            description = "Fastest and most budget-friendly model for high-throughput tasks.",
            contextWindow = 1_048_576,
            maxOutputTokens = 65_536,
            inputPricePerMToken = 0.10,
            outputPricePerMToken = 0.40,
            bestFor = listOf("high-throughput processing", "low-latency", "cost-sensitive tasks"),
        ),
        ModelMetadata(
